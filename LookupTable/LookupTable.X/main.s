...
cycle_counter	EQU 0x22
note_pointer	EQU 0x23
...
MainLoop:
    ...
    DECFSZ cycle_counter,1
    GOTO keep_going
    CALL decriment_note_pointer
keep_going:
    MOVF note_pointer,0
    CALL Note_Table
    CALL LongDelay		;2
...
decriment_note_pointer:
    DECFSZ note_pointer,1
    GOTO keep_note
    MOVLW 0x0F
    MOVWF note_pointer
keep_note:
...
Note_Table:
    ADDWF PCL,1			;add program counter offset currently in w
    RETLW 238
    RETLW 212
    RETLW 189
    RETLW 178
